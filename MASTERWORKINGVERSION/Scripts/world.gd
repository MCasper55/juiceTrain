...
func pick_next_scene():
	if current_scene.is_in_group("home"):
		...
		if rand == 1:
			Global.next_scene = "res://Rooms/scene_1.tscn"
		elif rand == 2:
			Global.next_scene = "res://Rooms/scene_2.tscn"
		else:
			Global.next_scene = "res://Rooms/newDevicesCannotConnectToTheEgg/Scenes/egg_room.tscn"
